...
def Rotar_Horario(punto,angulo):
    ...
    xp = int(punto[0]*math.cos(rad)-punto[1]*math.sin(rad))
    yp = int(punto[0]*math.sin(rad)+punto[1]*math.cos(rad))
    p = [xp,yp]
    return p

def Rotar_AntiHorario(punto,angulo):
    rad = math.radians(angulo)
    xp = int(punto[0]*math.sin(rad)+punto[1]*math.cos(rad))
    yp = int(-punto[0]*math.cos(rad)+punto[1]*math.sin(rad))
    p = [xp,yp]
    return p
